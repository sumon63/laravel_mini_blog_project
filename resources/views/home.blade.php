    ...
    <body class="antialiased">
        <nav class="navbar" style="background-color: tomato;">
            <div class="container-fluid">
              <a class="navbar-brand text-white ml-4" style="font-size: 30px" href="#">Mini Blog</a>
            </div>
            @if (Route::has('login'))
        ...
        <div class="relative  justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table" style="background-color:#263553">
                            <tbody>
                                @foreach ($posts as $post)
                                    <tr>
                                        <td class="p-3">
                                            <p style="color: white; font-size:20px; margin-bottom:0px">{{$post->title}}</p>
                                            <p style="color:#a8b9d2">{{$post->body}}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
